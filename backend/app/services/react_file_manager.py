...
from app.services.ui_components_extended import (
    get_accordion_component,
    get_tabs_component,
    get_tooltip_component,
    get_popover_component,
    get_dropdown_menu_component,
    get_toggle_component,
    get_radio_group_component,
    get_table_component,
    get_toast_component
)
...
"""
    ...
    def generate_ui_components(self) -> Dict[str, str]:
        ...
        # Button component (rest of file continues...)
...
'''
        ...
        # Avatar component
        files["src/components/ui/avatar.tsx"] = '''import * as React from "react"
...
'''
        ...
        # Progress component
        files["src/components/ui/progress.tsx"] = '''import * as React from "react"
...
'''
        ...
        # Accordion component
        files["src/components/ui/accordion.tsx"] = get_accordion_component()
        
        # Tabs component
        files["src/components/ui/tabs.tsx"] = get_tabs_component()
        
        # Tooltip component
        files["src/components/ui/tooltip.tsx"] = get_tooltip_component()
        
        # Popover component
        files["src/components/ui/popover.tsx"] = get_popover_component()
        
        # Dropdown Menu component
        files["src/components/ui/dropdown-menu.tsx"] = get_dropdown_menu_component()
        
        # Toggle component
        files["src/components/ui/toggle.tsx"] = get_toggle_component()
        
        # Radio Group component
        files["src/components/ui/radio-group.tsx"] = get_radio_group_component()
        
        # Table component
        files["src/components/ui/table.tsx"] = get_table_component()
        
        # Toast component (Sonner)
        files["src/components/ui/sonner.tsx"] = get_toast_component()
